...
from difference_of_squares import differenceOpti, difference, square_of_sum, sum_of_squares
...
class DifferenceOfSquaresTest(unittest.TestCase):
    ...
    def test_difference_opti_of_squares_1(self):
        self.assertEqual(differenceOpti(1), 0)

    def test_difference_opti_of_squares_5(self):
        self.assertEqual(differenceOpti(5), 170)

    def test_difference_opti_of_squares_100(self):
        self.assertEqual(differenceOpti(100), 25164150)
